...
module.exports = {
	...
	execute: async (interaction, bot) => {
		...
		if (feature === 'syntax') {
			...
			const desc = `**NOTE**: The bot also tracks message edits for up to 15 seconds if you need to adjust your query or fix a mistake you made when initially invoking the bot with a message.`
